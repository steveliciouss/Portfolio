...
export default function Navbar({ darkMode, setDarkMode }) {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 backdrop-blur-md border-b shadow-sm
      ...
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className={`relative w-16 h-9 rounded-full p-1 hover:scale-105
              ${darkMode
          ...
          >
            <span
              className={`absolute top-1 left-1 w-7 h-7 rounded-full flex items-center justify-center text-xs
                ${darkMode
